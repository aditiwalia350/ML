...
print("For C=1 and p=2 accuracy is ",accuracy*100)

classifier = SVC(C=3,kernel = 'poly',degree=2)
classifier.fit(X_train, y_train)
# Predicting the Test set results
y_pred = classifier.predict(X_test)
# Making the Confusion Matrix
...
classifier = SVC(C=1,kernel = 'poly',degree=4)
classifier.fit(X_train, y_train)
# Predicting the Test set results
y_pred = classifier.predict(X_test)
# Making the Confusion Matrix
...
total_right_predictions=cm[0][0]+cm[1][1]
accuracy=float(total_right_predictions/len(X_test))
print("For C=1 and p=4 accuracy is ",accuracy*100)


classifier = SVC(C=3,kernel = 'poly',degree=4)
classifier.fit(X_train, y_train)
# Predicting the Test set results
y_pred = classifier.predict(X_test)
# Making the Confusion Matrix
...
total_right_predictions=cm[0][0]+cm[1][1]
accuracy=float(total_right_predictions/len(X_test))
print("For C=3 and p=4 accuracy is ",accuracy*100)
